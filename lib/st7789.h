...
void st7789_cmd(uint8_t cmd, const st7789* disp);
void st7789_dat(uint8_t dat, const st7789* disp);
void st7789_dat16(uint16_t dat, const st7789* disp);

void st7789_init(const st7789* disp);

void st7789_setWindow(int16_t x0, int16_t y0, uint8_t w, uint8_t h, const st7789* disp);
void st7789_setCursor(int16_t x, int16_t y, const st7789* disp);
static inline void st7789_default(const st7789* disp);

void st7789_fill(uint16_t color, const st7789* disp);
void st7789_drawPixel(int16_t x, int16_t y, uint16_t color, const st7789* disp);
void st7789_drawRect(int16_t x0, int16_t y0, uint8_t w, uint8_t h, uint16_t color, const st7789* disp);

void st7789_drawFont5x7(const uint8_t* buf, int16_t x0, int16_t y0, uint8_t size, uint16_t color, const st7789* disp);
void st7789_drawChar(char ch, int16_t x0, int16_t y0, uint8_t size, uint16_t color, const uint8_t* ascii_font, const st7789* disp);
void st7789_drawText(const char* text, int16_t x, int16_t y, uint8_t size, uint16_t color, const uint8_t* ascii_font, const st7789* disp);
